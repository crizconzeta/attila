...
[![Package Build and Test](https://github.com/crizconzeta/attila/actions/workflows/main.yml/badge.svg)](https://github.com/crizconzeta/attila/actions/workflows/main.yml)

Changes:
 - Replace Google fonts and cdn 
